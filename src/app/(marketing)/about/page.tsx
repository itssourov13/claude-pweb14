    ...
    <>
      ...
      <Section className="max-w-[760px] pt-0">
        <div className="prose prose-neutral dark:prose-invert">
          ...
          <p>
            I care most about the unglamorous middle of a project: the form that
            has to actually validate correctly, the loading state nobody
            designed, the edge case that shows up in week six. That&apos;s where
            most products either earn or lose trust.
          </p>
          <p>
            ...
            <Link href="/writing">writing page</Link>.
          </p>
        </div>
      </Section>
    </>
